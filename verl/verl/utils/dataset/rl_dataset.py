...
class RLHFDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        # randomly select 100 samples to debug the program
        # self.dataframe = self.dataframe.shuffle(seed=42) # for debugging
        # self.dataframe = self.dataframe.select(range(32)) # for debugging
