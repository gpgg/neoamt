...
__all__ = [
    ...
    "AgentLoopConfig",
    "TraceConfig",
    "RelativeQualityEstimationSamplingConfig",
    "ParamsConfig",
    "SearchConfig",
    "ToolInstancesConfig",
    "ToolsConfig",
...
@dataclass
class RelativeQualityEstimationSamplingConfig:
    enable: bool = False
    alpha: float = 50.0
    beta: float = 0.0
    gamma: float = 10.0
...
@dataclass
class SearchConfig:
    class_path: str = "verl.workers.agent.tools.search_tool.SearXNGSearchTool"
    params: ParamsConfig = field(default_factory=ParamsConfig)

@dataclass
class ToolInstancesConfig:
...
class ToolsConfig:
    ...
    search_lang_side: str = "src"
    tool_instances: ToolInstancesConfig = field(default_factory=ToolInstancesConfig)
...
class RolloutConfig(BaseConfig):
    ...
    relative_quality_estimation_sampling: RelativeQualityEstimationSamplingConfig = field(default_factory=RelativeQualityEstimationSamplingConfig)
